 ...
 *
 * <p>Esta clase combina información del cliente con datos personales básicos para facilitar la
 * transferencia de datos entre capas de la aplicación, especialmente en operaciones REST.
 *
 * <p>Incluye tanto atributos específicos de cliente como campos heredados de la entidad Persona.
 *
...
public class ClienteDTO {
  ...
  /** Fecha de registro del cliente en el sistema. Formato: YYYY-MM-DD */
  ...
  /**
   * Identificador de la finca asociada al cliente (opcional). Puede ser nulo si el cliente no tiene
   * finca asignada.
   */
