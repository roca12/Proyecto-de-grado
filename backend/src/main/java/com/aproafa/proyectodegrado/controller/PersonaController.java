...
public class PersonaController {
    ...
    try {
      ...
      diagnosticInfo.put(
          ...
          applicationContext != null
              ? Arrays.asList(applicationContext.getBeanDefinitionNames()).size()
              : 0);
      ...
      if (personaService != null) {
        try {
          ...
          diagnosticInfo.put(
              "personaServiceResultSize", personas != null ? personas.size() : "null");
        } catch (Exception e) {
  ...
  public ResponseEntity<?> getAllPersonas() {
    ...
    try {
      ...
      List<Persona> personas = personaService.getAllPersonas();
      System.out.println(
          "PersonaService.getAllPersonas() returned: "
              + (personas != null ? personas.size() + " items" : "null"));
