        ...
        <div className="main-container">
            ...
            <div className="registro-persona-container">
                ...
                <form className="registro-form">
                    ...
                    <input type="text" placeholder="Apellidos" className="registro-input" />
                    <input type="text" placeholder="Documento" className="registro-input" />
                    <input type="text" placeholder="Teléfono" className="registro-input" />
                    <input type="text" placeholder="Dirección" className="registro-input" />
                    ...
                    <div className="registro-botones">
                        ...
                        <button type="button" onClick={handleRegister} className="btn-registrar">
                            Registrar
                        </button>
                    </div>
                </form>
