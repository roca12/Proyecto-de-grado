        ...
        <div className="main-container">
            ...
            <div className="registro-actividad-container">
                ...
                <form className="registro-form">
                    ...
                    <input type="text" placeholder="Tipo de actividad" className="registro-input" />
                    <input type="text" placeholder="Fecha de inicio" className="registro-input" />
                    <input type="text" placeholder="Fecha de finalización" className="registro-input" />
                    <input type="text" placeholder="Descripción" className="registro-input" />
