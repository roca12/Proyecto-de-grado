                ...
                <div style={{ display: "flex", alignItems: "center", position: "relative" }}>
                  ...
                  {showHelp && (
                      ...
                      >
                        ...
                        <ul>
                          <li>
                            <strong>Registrar Insumo:</strong> Abre el formulario para crear un nuevo insumo.
                          </li>
                          <li>
                            <strong>Actualizar:</strong> Permite modificar los datos de un insumo existente.
                          </li>
                          <li>
                            <strong>Eliminar:</strong> Elimina permanentemente el insumo seleccionado.
                          </li>
                        </ul>
                      </div>
                  )}
              ...
              <table className="insumos-table">
                ...
                {insumos.map((insumo) => (
                    <tr key={insumo.idInsumo}>
                      ...
                      <td>
                        {insumo.proveedor?.nombre || (mensajes[insumo.idInsumo] ? (
                      ...
                      <td className="actions-cell">
                        {!mensajes[insumo.idInsumo] && insumo.cantidadDisponible === 0 && (
                            <div
                                style={{
                        ...
                        <button className="btn-actualizar" onClick={() => abrirModalActualizar(insumo)}>
                          <FaEdit /> Actualizar
                        </button>
                        <button
              ...
              <div className="modal-content">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="form-group">
                    ...
                    />
                    <small>La cantidad solo se puede modificar registrando compras</small>
                  </div>
