 ...
 * http://localhost:3000) se comunique con el backend Spring Boot, permitiendo el acceso
 * a los endpoints definidos.</p>
 */
@Configuration
public class CorsConfig {
  ...
  public WebMvcConfigurer corsConfigurer() {
    return new WebMvcConfigurer() {
       ...
       * También se permite el uso de credenciales (cookies, headers de autenticación, etc.)
       * y se establece un tiempo máximo de cache para la política CORS de 3600 segundos.
       *
