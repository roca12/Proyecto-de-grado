 ...
 * Proporciona los endpoints necesarios para crear, listar y eliminar productos.
 *
...
public class ProductoController {
     ...
     *
     * Este método recibe los datos del producto a través de un DTO,
     * y utiliza el servicio de producto para crear el nuevo producto en la base de datos.
     *
     * @param productoDTO Datos del producto a crear. Contiene la información necesaria para la creación.
     ...
     *
     * Este método obtiene todos los productos almacenados en el sistema mediante el servicio de productos.
     *
     ...
     *
     * Este método elimina un producto específico mediante su ID utilizando el servicio de productos.
     *
