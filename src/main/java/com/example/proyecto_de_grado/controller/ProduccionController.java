...
public class ProduccionController {
     ...
     *
     * Este método recibe los datos de producción a través de un DTO,
     * y utiliza el servicio de producción para crear la nueva producción en la base de datos.
     *
     ...
     *
     * Este método recibe el ID de la producción, la cantidad cosechada y la fecha de cosecha.
     * Luego, utiliza el servicio de producción para actualizar el estado de la producción como cosechada.
     *
    ...
    public ResponseEntity<Void> cosecharProduccion(@PathVariable Integer id,
     ...
     *
     * Este método obtiene todas las producciones almacenadas en el sistema mediante el servicio de producción.
     *
     ...
     *
     * Este método obtiene una producción mediante su ID y la devuelve en formato DTO.
     *
