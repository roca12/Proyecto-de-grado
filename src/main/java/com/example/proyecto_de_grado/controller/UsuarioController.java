 ...
 *   <li>Gestión de cuentas de usuario (CRUD)</li>
...
public class UsuarioController {
     ...
     * <ul>
     *   <li>Tipo de usuario (ADMIN o USER)</li>
     *   <li>Existencia previa de la persona</li>
     *   <li>Existencia de la finca asociada</li>
     * </ul>
     *
     ...
     * <ul>
     *   <li>Validación de credenciales con Spring Security</li>
     *   <li>Generación de token JWT con información del usuario</li>
     *   <li>Respuesta con token y datos básicos del usuario</li>
     * </ul>
     *
     * @param authRequest Objeto con credenciales de autenticación (ID y contraseña)
     * @return ResponseEntity con token JWT y datos del usuario (200 OK) o mensaje de error (401 Unauthorized)
     */
    @PostMapping("/login")
        ...
        try {
            ...
            authenticationManager.authenticate(
                    new UsernamePasswordAuthenticationToken(
                            String.valueOf(authRequest.getIdPersona()),
