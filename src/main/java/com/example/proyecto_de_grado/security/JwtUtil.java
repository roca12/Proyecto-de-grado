 ...
 *
 * <p>Esta clase proporciona métodos para generar, validar y extraer información de los tokens JWT utilizados en el sistema.
 * Se encarga de firmar el token, verificar su expiración y extraer datos del token, como el nombre de usuario.</p>
 *
