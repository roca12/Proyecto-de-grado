 ...
 *
 * <p>Esta clase configura la seguridad de la aplicación, incluyendo la autenticación de usuarios mediante JWT,
 * la autorización basada en roles y la gestión de sesiones sin estado (stateless).</p>
 *
 * <p>Se utiliza un filtro personalizado para verificar el JWT en cada solicitud, y se configuran las reglas de acceso
 * a las diferentes rutas de la API.</p>
 *
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/usuarios/login", "/api/usuarios", "/api/usuarios/register").permitAll()
                        // Rutas de actividades accesibles solo por usuarios con ciertos roles
                        .requestMatchers("/api/actividades/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_USER")
                        // Rutas de administración solo accesibles por administradores
                        .requestMatchers("/api/usuarios/admin/**").hasAnyAuthority("ROLE_ADMIN")
    ...
    /**
     * Configura un codificador de contraseñas personalizado.
     * Este codificador no aplica un hash real, solo compara la contraseña sin cifrar.
     *
    ...
    public PasswordEncoder passwordEncoder() {
        return new PasswordEncoder() {
            ...
            public boolean matches(CharSequence rawPassword, String encodedPassword) {
                return rawPassword.toString().equals(encodedPassword); // Compara las contraseñas de manera simple
            }
        };
    }
