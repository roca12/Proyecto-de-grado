 ...
 * Utiliza la librería iText para construir y formatear el documento PDF.
 *
...
public class FacturaService {
    ...
    private void agregarInformacionVenta(Document document, VentaDTO venta) throws DocumentException {
        ...
        if (venta.getFechaVenta() != null) {
            document.add(new Paragraph("Fecha: " +
                    venta.getFechaVenta().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm")), infoFont));
        }
    ...
    private void agregarFilaProducto(PdfPTable table, DetalleVentaDTO detalle) {
        ...
        String precioStr = detalle.getPrecioUnitario() != null ? "$" + detalle.getPrecioUnitario() : "$0.00";
