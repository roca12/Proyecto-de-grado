 ...
 *
 * <p>Esta clase implementa la interfaz {@link UserDetailsService} para cargar el usuario desde la base de datos
 * usando su ID y convertirlo a un objeto {@link UserDetails} que será usado para la autenticación en Spring Security.</p>
 *
 * <p>Autor: Santiago Arias</p>
 */
@Service
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    /**
     * Carga un {@link UserDetails} de Spring Security a partir del nombre de usuario (en este caso, el ID del usuario).
     *
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        String rol = "ROLE_" + usuario.get().getTipoUsuario().toUpperCase(); // Ej: "ADMIN" → "ROLE_ADMIN"
