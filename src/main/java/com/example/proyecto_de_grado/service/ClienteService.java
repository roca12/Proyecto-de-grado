 ...
 *
 * <p>Esta clase contiene los métodos para crear, obtener, actualizar y eliminar clientes en la base de datos.
 * Además, convierte entre la entidad {@link Cliente} y el DTO {@link ClienteDTO} para la manipulación de datos.</p>
 *
...
public class ClienteService {
    ...
    public ClienteDTO crearCliente(ClienteDTO clienteDTO) {
        ...
        Optional<Persona> personaExistente = personaRepository.findByNumeroIdentificacion(clienteDTO.getNumeroIdentificacion());
        Persona persona;
        ...
        // Buscar la finca
        Finca finca = fincaRepository.findById(clienteDTO.getIdFinca())
