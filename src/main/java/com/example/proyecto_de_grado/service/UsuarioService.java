 ...
 *
 * <p>Esta clase ofrece métodos para realizar operaciones relacionadas con usuarios, como obtener, guardar, eliminar
 * y verificar la existencia de un usuario. También permite la relación de los usuarios con personas, facilitando la
 * interacción entre estas entidades.</p>
 *
