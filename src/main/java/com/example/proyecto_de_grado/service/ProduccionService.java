...
/**
 * Servicio para gestionar las operaciones relacionadas con la producción agrícola.
 * Permite crear, cosechar, listar, actualizar y eliminar producciones,
 * así como gestionar su estado y relación con fincas y productos.
 *
...
public class ProduccionService {
    ...
    /**
     * Registra la cosecha de una producción existente.
     * Actualiza la cantidad cosechada, la fecha de cosecha y el estado a COSECHADO.
     * Además, actualiza el inventario de productos con la cantidad cosechada.
     *
     ...
     * No permite actualizar producciones que ya han sido cosechadas.
     *
     ...
     * No permite eliminar producciones que ya han sido cosechadas.
     *
