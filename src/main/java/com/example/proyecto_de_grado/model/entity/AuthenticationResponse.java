 ...
 *
 * <p>Contiene la información que se devuelve al cliente
 * luego de una autenticación exitosa, incluyendo el token de acceso
 * y los datos básicos del usuario autenticado.</p>
 *
