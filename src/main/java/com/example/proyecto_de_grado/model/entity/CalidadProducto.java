 ...
 *
 * Esta entidad permite registrar la clasificación de calidad (mediante un enumerado) y
 * observaciones detalladas sobre los productos obtenidos en una producción agrícola.
 *
 * <p>Relaciones:
 * <ul>
 *   <li>Muchos a Uno con {@link Produccion}: Cada evaluación de calidad está asociada a una sola producción.</li>
 * </ul>
 *
 * <p>Atributos:
 * <ul>
 *   <li>{@code idCalidad}: Identificador único de la evaluación de calidad.</li>
 *   <li>{@code produccion}: Producción a la que pertenece esta evaluación.</li>
 *   <li>{@code calidad}: Nivel de calidad asignado (EXCELENTE, BUENA, REGULAR, MALA).</li>
 *   <li>{@code observaciones}: Comentarios adicionales u observaciones relevantes al evaluar la calidad.</li>
 * </ul>
 */
@Data
@Entity
