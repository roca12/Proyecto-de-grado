...
/**
 * Enumeración que representa las posibles unidades de medida para los insumos.
 *
 * <p>Las unidades de medida disponibles son Kilogramo (Kg), Litro (LITRO), Bolsa (BOLSA) y Unidad (UNIDAD).</p>
 *
