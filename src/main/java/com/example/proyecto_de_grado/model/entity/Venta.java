...
/**
 * Representa una venta realizada en el sistema. Contiene información sobre el cliente, el empleado,
 * la fecha, el método de pago, el total y los detalles asociados a la venta.
 *
...
public class Venta {
  ...
  /**
   * Lista de detalles asociados a esta venta. Cada detalle representa un producto o servicio
   * vendido.
   */
