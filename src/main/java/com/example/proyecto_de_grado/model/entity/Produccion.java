 ...
 * cantidad cosechada y evaluación de calidad.</p>
 *
 * <p>Relaciones:
 * <ul>
 *   <li>Muchos a Uno con {@link Producto}: Un producto puede estar presente en múltiples producciones.</li>
 *   <li>Muchos a Uno con {@link Finca}: Cada producción pertenece a una finca específica.</li>
 *   <li>Uno a Muchos con {@link CalidadProducto}: Una producción puede tener múltiples evaluaciones de calidad.</li>
 * </ul></p>
 *
 * <p>Atributos:
 * <ul>
 *   <li>{@code idProduccion}: Identificador único de la producción.</li>
 *   <li>{@code producto}: Producto agrícola que se está cultivando.</li>
 *   <li>{@code finca}: Finca en la que se lleva a cabo la producción.</li>
 *   <li>{@code fechaSiembra}: Fecha en la que se sembró el producto.</li>
 *   <li>{@code fechaCosecha}: Fecha en la que se cosechó el producto (puede ser nula si aún no se ha cosechado).</li>
 *   <li>{@code estado}: Estado actual de la producción (enum: EN_CRECIMIENTO, LISTO_PARA_COSECHA, COSECHADO).</li>
 *   <li>{@code cantidadCosechada}: Cantidad total cosechada, expresada como número decimal.</li>
 *   <li>{@code calidades}: Lista de evaluaciones de calidad asociadas a esta producción.</li>
 * </ul></p>
 */
@Data
@Entity
