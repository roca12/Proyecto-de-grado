 ...
 * información específica como cantidad, precio unitario y subtotal de cada ítem.
 * Facilita la transferencia de datos entre capas de la aplicación para el manejo de líneas de venta.
 *
 * <p>Se basa en la estructura de la tabla 'detalle_venta' y mantiene la relación con las ventas
 * a través del identificador de venta correspondiente.
 *
