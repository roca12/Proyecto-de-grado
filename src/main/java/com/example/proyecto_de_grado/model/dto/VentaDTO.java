 ...
 * esenciales de la transacción como cliente, empleado, fecha, método de pago y total. Facilita la
 * transferencia de datos entre capas de la aplicación, especialmente en operaciones REST.
 *
 * <p>Se basa en la estructura de la tabla 'venta' y contiene únicamente los campos principales sin
 * relaciones complejas para optimizar el rendimiento.
 *
...
public class VentaDTO {
  ...
  /** Fecha y hora cuando se realizó la venta. Formato: YYYY-MM-DD HH:MM:SS */
  @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
  private LocalDateTime fechaVenta;

  /**
   * Método de pago utilizado en la venta. Valores posibles: "Efectivo", "Tarjeta", "Transferencia",
   * "Otro"
   */
