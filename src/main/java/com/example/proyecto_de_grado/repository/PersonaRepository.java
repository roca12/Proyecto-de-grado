 ...
 * para verificar la existencia de una persona por su número de identificación y para buscar una persona por
 * este mismo número.</p>
 *
...
public interface PersonaRepository extends JpaRepository<Persona, Integer> {
     ...
     * @return {@code true} si existe una persona con el número de identificación, {@code false} en caso contrario.
     */
